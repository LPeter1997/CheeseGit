        ...
        hunks: [
          {
            ...
            new_start: 1,
            lines: [
              { kind: "Context", content: "function add(a, b) {", old_lineno: 1, new_lineno: 1, highlights: [] },
              { kind: "Deletion", content: "  return a - b;", old_lineno: 2, new_lineno: null, highlights: [] },
              { kind: "Addition", content: "  return a + b;", old_lineno: null, new_lineno: 2, highlights: [] },
              { kind: "Context", content: "}", old_lineno: 3, new_lineno: 3, highlights: [] },
            ],
          },
        ],
      };
      ...
      hunks: [
        {
          ...
          new_start: 1,
          lines: [
            { kind: "Context", content: "const name = 'Alice';", old_lineno: 1, new_lineno: 1, highlights: [] },
            { kind: "Deletion", content: "console.log(name);", old_lineno: 2, new_lineno: null, highlights: [] },
            { kind: "Addition", content: "console.log(name, name);", old_lineno: null, new_lineno: 2, highlights: [] },
            { kind: "Context", content: "console.log(age);", old_lineno: 3, new_lineno: 3, highlights: [] },
          ],
        },
      ],
    });
